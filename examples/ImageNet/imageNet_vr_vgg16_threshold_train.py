...
class CatNet_training(nn.Module):
    ...
    #def forward(self, x):
        ...
        x,y = threshold_training_snn(self.conv8(x),self.conv8(y),threshold_pre_8,self.T,9)
        ...
        x,y = threshold_training_snn(self.conv11(x),self.conv11(y),threshold_pre_11,self.T,17)
        x,y = threshold_training_snn(self.conv12(x),self.conv12(y),threshold_pre_12,self.T,17)
        ...
        x,y = threshold_training_snn(self.classifier0(x),self.classifier0(y),threshold_pre_14,self.T,17)
        x,y = threshold_training_snn(self.classifier3(x),self.classifier3(y),threshold_pre_15,self.T,17)
...
def test_snn(model, device, test_loader):
    ...
    threshold_pre_8 = np.ones(512)*max_1
    ...
    threshold_pre_14 = np.ones(4096)*max_1
    threshold_pre_15 = np.ones(4096)*max_1
    p1 = np.ones(64)*max_1
...
def main():
    ...
    snn_loader = torch.utils.data.DataLoader(snn_dataset, batch_size=1, shuffle=True)
