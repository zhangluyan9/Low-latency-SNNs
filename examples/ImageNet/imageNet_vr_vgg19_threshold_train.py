...
def transfer_model(src, dst, quantize_bit=32):
    ...
    reshape_dict['features.20.weight'] = dst_dict['features.20.weight']*max_1
    reshape_dict['features.30.weight'] = dst_dict['features.30.weight']*max_1
    reshape_dict['features.40.weight'] = dst_dict['features.40.weight']*max_1
...
class CatNet_training(nn.Module):
    ...
    def __init__(self, T):
        ...
        self.conv8 = snn.conv(256, 256, kernelSize=3, padding=1,bias=True)
        self.pool3 = snn.pool(2)
        self.conv9 = snn.conv(256, 512, kernelSize=3, padding=1,bias=True)
        ...
        self.conv14 = snn.conv(512, 512, kernelSize=3, padding=1,bias=True)
        self.conv15 = snn.conv(512, 512, kernelSize=3, padding=1,bias=True)
        self.conv16 = snn.conv(512, 512, kernelSize=3, padding=1,bias=True)
    ...
    def forward(self, x,threshold_pre_1,threshold_pre_2,threshold_pre_3,threshold_pre_4,threshold_pre_5,threshold_pre_6,threshold_pre_7,threshold_pre_8,threshold_pre_9,threshold_pre_10,threshold_pre_11,threshold_pre_12,threshold_pre_13,threshold_pre_14,threshold_pre_15,threshold_pre_16,p1,p2,p3,p4,p5):
    #def forward(self, x):
        ...
        x,y = threshold_training_snn(self.conv7(x),self.conv7(y),threshold_pre_7,self.T,9)
        x,y = threshold_training_snn(self.conv8(x),self.conv8(y),threshold_pre_8,self.T,10)
        x,y = threshold_training_snn(self.pool3(x),self.pool3(y),p3,self.T,11)

        x,y = threshold_training_snn(self.conv9(x),self.conv9(y),threshold_pre_9,self.T,12)
        x,y = threshold_training_snn(self.conv10(x),self.conv10(y),threshold_pre_10,self.T,13)
        x,y = threshold_training_snn(self.conv11(x),self.conv11(y),threshold_pre_11,self.T,14)
        x,y = threshold_training_snn(self.conv12(x),self.conv12(y),threshold_pre_12,self.T,15)
        x,y = threshold_training_snn(self.pool4(x),self.pool4(y),p4,self.T,16)

        x,y = threshold_training_snn(self.conv13(x),self.conv13(y),threshold_pre_13,self.T,17)
        x,y = threshold_training_snn(self.conv14(x),self.conv14(y),threshold_pre_14,self.T,18)
        x,y = threshold_training_snn(self.conv15(x),self.conv15(y),threshold_pre_15,self.T,19)
        x,y = threshold_training_snn(self.conv16(x),self.conv16(y),threshold_pre_16,self.T,20)
        x,y = threshold_training_snn(self.pool5(x),self.pool5(y),p5,self.T,21)
        x = self.classifier1(x)
        return self.snn.sum_spikes(x)/self.T,threshold_pre_1,threshold_pre_2,threshold_pre_3,threshold_pre_4,threshold_pre_5,threshold_pre_6,threshold_pre_7,threshold_pre_8,threshold_pre_9,threshold_pre_10,threshold_pre_11,threshold_pre_12,threshold_pre_13,threshold_pre_14,threshold_pre_15,threshold_pre_16,p1,p2,p3,p4,p5
...
def test_snn(model, device, test_loader):
    ...
    threshold_pre_16 = f['threshold_pre_16']
    p1 = f['p1']
    p2 = f['p2']
    p3 = f['p3']
    p4 = f['p4']
    ...
    threshold_pre_1 = np.ones(64)*max_1
    threshold_pre_2 = np.ones(64)*max_1
    threshold_pre_3 = np.ones(128)*max_1
    threshold_pre_4 = np.ones(128)*max_1
    threshold_pre_5 = np.ones(256)*max_1
    threshold_pre_6 = np.ones(256)*max_1
    threshold_pre_7 = np.ones(256)*max_1
    threshold_pre_8 = np.ones(256)*max_1
    threshold_pre_9 = np.ones(512)*max_1
    threshold_pre_10 = np.ones(512)*max_1
    threshold_pre_11 = np.ones(512)*max_1
    threshold_pre_12 = np.ones(512)*max_1
    threshold_pre_13 = np.ones(512)*max_1
    threshold_pre_14 = np.ones(512)*max_1
    threshold_pre_15 = np.ones(512)*max_1
    threshold_pre_16 = np.ones(512)*max_1


    p1 = np.ones(64)*max_1
    p2 = np.ones(128)*max_1
    p3 = np.ones(256)*max_1
    p4 = np.ones(512)*max_1
    p5 = np.ones(512)*max_1
    ...
    with torch.no_grad():
        ...
        for data, target in test_loader:
            data, target = data.to(device), target.to(device)
            output,threshold_pre_1,threshold_pre_2,threshold_pre_3,threshold_pre_4,threshold_pre_5,threshold_pre_6,threshold_pre_7,threshold_pre_8,threshold_pre_9,threshold_pre_10,threshold_pre_11,threshold_pre_12,threshold_pre_13,threshold_pre_14,threshold_pre_15,threshold_pre_16,p1,p2,p3,p4,p5 = model(data,threshold_pre_1,threshold_pre_2,threshold_pre_3,threshold_pre_4,threshold_pre_5,threshold_pre_6,threshold_pre_7,threshold_pre_8,threshold_pre_9,threshold_pre_10,threshold_pre_11,threshold_pre_12,threshold_pre_13,threshold_pre_14,threshold_pre_15,threshold_pre_16,p1,p2,p3,p4,p5)
            test_loss +=  F.cross_entropy(output, target, reduction='sum').item()  # sum up batch loss
            pred = output.argmax(dim=1, keepdim=True)  # get the index of the max log-probability
            correct += pred.eq(target.view_as(pred)).sum().item()
            print(pred.eq(target.view_as(pred)).sum().item())
            np.savez('image_200_full.npz',threshold_pre_1=threshold_pre_1,threshold_pre_2=threshold_pre_2,threshold_pre_3=threshold_pre_3,threshold_pre_4=threshold_pre_4,threshold_pre_5=threshold_pre_5,threshold_pre_6=threshold_pre_6,threshold_pre_7=threshold_pre_7,threshold_pre_8=threshold_pre_8,threshold_pre_9 = threshold_pre_9,threshold_pre_10 = threshold_pre_10,threshold_pre_11 = threshold_pre_11,threshold_pre_12=threshold_pre_12,threshold_pre_13=threshold_pre_13,threshold_pre_14=threshold_pre_14,threshold_pre_15=threshold_pre_15,threshold_pre_16=threshold_pre_16,p1=p1,p2=p2,p3=p3,p4=p4,p5=p5)

            """
            print("threshold_pre_1",threshold_pre_1[0])
            print("threshold_pre_2",threshold_pre_2[0])
            print("threshold_pre_3",threshold_pre_3[0])
            print("threshold_pre_4",threshold_pre_4[0])
            print("threshold_pre_5",threshold_pre_5[0])
            print("threshold_pre_6",threshold_pre_6[0])
            """
    test_loss /= len(test_loader.dataset)
...
def main():
    ...
    #val_dataset
    snn_dataset = SpikeDataset(train_dataset, T = args.T,theta = max_1-0.0001)
    ...
    from models.vgg_imagenet_0_8 import VGG,CatVGG,VGG1
    ...
    model = VGG('VGG19',bias = True).to(device)
    model1 = VGG1('VGG19',bias = True).to(device)
    
    snn_model = CatVGG('VGG19', args.T, bias = True).to(device)
    #imageNmybn19_c_d_2_new_4_1218_200
    #imageNmybn19_c_d_2_new_4_1227_200_full
    model1.load_state_dict(torch.load("imageNmybn19_c_d_2_new_4_1227_200_full.pt"), strict=False)    
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if correct>correct_:
            correct_ = correct
            torch.save(model1.state_dict(), "imageNmybn19_c_d_2_new_4_1218_48.pt")
        k+=1
        scheduler.step()
    ...
    reshape_dict['conv8.weight'] = nn.Parameter(pre_dict['features.18.weight'],requires_grad=False)
    reshape_dict['conv8.bias'] = nn.Parameter(pre_dict['features.18.bias'],requires_grad=False)
    ...
    reshape_dict['conv11.weight'] = nn.Parameter(pre_dict['features.26.weight'],requires_grad=False)
    reshape_dict['conv11.bias'] = nn.Parameter(pre_dict['features.26.bias'],requires_grad=False)

    reshape_dict['conv12.weight'] = nn.Parameter(pre_dict['features.28.weight'],requires_grad=False)
    reshape_dict['conv12.bias'] = nn.Parameter(pre_dict['features.28.bias'],requires_grad=False)
    ...
    reshape_dict['conv14.weight'] = nn.Parameter(pre_dict['features.34.weight'],requires_grad=False)
    reshape_dict['conv14.bias'] = nn.Parameter(pre_dict['features.34.bias'],requires_grad=False)

    reshape_dict['conv15.weight'] = nn.Parameter(pre_dict['features.36.weight'],requires_grad=False)
    reshape_dict['conv15.bias'] = nn.Parameter(pre_dict['features.36.bias'],requires_grad=False)

    reshape_dict['conv16.weight'] = nn.Parameter(pre_dict['features.38.weight'],requires_grad=False)
    reshape_dict['conv16.bias'] = nn.Parameter(pre_dict['features.38.bias'],requires_grad=False)
    ...
    reshape_dict['pool3.weight'] = nn.Parameter(pre_dict['features.20.weight'],requires_grad=False)
    reshape_dict['pool4.weight'] = nn.Parameter(pre_dict['features.30.weight'],requires_grad=False)
    reshape_dict['pool5.weight'] = nn.Parameter(pre_dict['features.40.weight'],requires_grad=False)
