...
def test_snn(model, device, test_loader):
    ...
    p4 = f['p4']
    """
    f = np.load("cifar_100_t_60.npz")
    threshold_pre_1 = f['threshold_pre_1']*max_1
    threshold_pre_2 = f['threshold_pre_2']*max_1
    threshold_pre_3 = f['threshold_pre_3']*max_1
    threshold_pre_4 = f['threshold_pre_4']*max_1
    threshold_pre_5 = f['threshold_pre_5']*max_1
    threshold_pre_6 = f['threshold_pre_6']*max_1
    threshold_pre_7 = f['threshold_pre_7']*max_1
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if correct>correct_:
            correct_ = correct
            torch.save(model.state_dict(), "cifar100_t_40_48.pt")
        scheduler.step()
