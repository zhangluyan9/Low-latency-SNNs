...
_C.DATA.TEST_SIZE = _C.DATA.IMG_SIZE
_C.DATA.TEST_BATCH_SIZE = _C.DATA.BATCH_SIZE
...
_C.AUG.PRESET = 'raug15'    # If use AUG.PRESET (e.g., 'raug15'), use the pre-defined preprocessing, ignoring the following settings.
# Color jitter factor
